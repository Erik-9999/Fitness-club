  ...
  // Déconnexion
    ...
    */
    public function apiDatePlanning(RequestInterface $request, ResponseInterface $response, $args)
    {
        ...
        $listeDates = $this->em->getRepository(Planification::class)->queryGetDatesByPartialDatePlanification($date);//var_dump($listeDates);die;
        ...
        //$response->getBody()->write(json_encode($listeUtilisateurs));
